...
import com.rmc.lamp.evaluator.PathEvaluator;
                            ...
                            if (x >= mPortrait.getDesireLeft() && x <= mPortrait.getDesireRight() && y >= mPortrait.getDesireTop() && y <= mPortrait.getDesireBottom()) {
                                ...
                                insert.addListener(new AnimatorListenerAdapter() {
                                    ...
                                    public void onAnimationEnd(Animator animation) {
                                        ...
                                        String text = tagView.tag.tag;
                                        Log.d("INFO", text);
                                        int color = getColorDec(text);
                                        tagView.tag.count++;
//                                        Random x = new Random();
//                                        int color = bg_color[x.nextInt(9)];

                                        String getcolor = ("#" + Integer.toHexString(color));
                                        RxBus.getInstance().post("Color", getcolor);
                                        tagView.setSource(tagView.tag);
                                        tagView.invalidate();
                                        settling(tagView);
                                    }

                                    private int getColorDec(String text) {
                                        int sendcolor = 0;
                                        if (text.equals("红色")) {
                                            sendcolor = getResources().getColor(R.color.silver);
                                        } else if (text.equals("橘色")) {
                                            sendcolor = getResources().getColor(R.color.orange);
                                        } else if (text.equals("黄色")) {
                                            sendcolor = getResources().getColor(R.color.yellow);
                                        } else if (text.equals("紫色")) {
                                            sendcolor = getResources().getColor(R.color.green);
                                        } else if (text.equals("绿色")) {
                                            sendcolor = getResources().getColor(R.color.lime);
                                        } else if (text.equals("蓝色")) {
                                            sendcolor = getResources().getColor(R.color.blue);
                                        } else if (text.equals("紫色")) {
                                            sendcolor = getResources().getColor(R.color.purple);
                                        } else if (text.equals("粉色")) {
                                            sendcolor = getResources().getColor(R.color.orange);
                                        }
                                        return sendcolor;
                                    }
