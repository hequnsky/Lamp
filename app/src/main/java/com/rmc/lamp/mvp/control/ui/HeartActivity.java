...
import com.rmc.lamp.utils.ImageProcessing;
...
//        heart_start.setOnClickListener(this);
        initConfig();
    }
    ...
    public void onResume() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(HeartActivity.this, "请先允许摄像头权限！", Toast.LENGTH_LONG).show();
        }
    ...
    public static void SendTcpMsg(int sm) {
        String s1 = null;
        if (sm == 0) {
            s1 = "FA" + " " + "AF" + " " + "03" + " " + "00" + " " + "00" + " " + "00" + " " + "00"
                    + " " + "00" + " " + "00" + " " + "00" + " " + "AF" + " " + "FA";

        } else {
            s1 = "FA" + " " + "AF" + " " + "03" + " " + "00" + " " + "00" + " " + "00" + " " + Integer.toHexString(sm)
                    + " " + "00" + " " + "00" + " " + "00" + " " + "AF" + " " + "FA";
        }
        Log.i("INFO", s1);
        try {
